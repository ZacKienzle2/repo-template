...
for repo in yaml.load(Path(".pre-commit-config.yaml").read_text(encoding="utf-8"))["repos"]:
    ...
    for hook in repo["hooks"]:
        rows.append((hook.get("alias", hook["id"]), str(repo.get("rev", "")), source))
actions = {}
...
| prettier-sources                     | v3.9.6      | <https://github.com/rbubley/mirrors-prettier>                  |
...
| check-github-workflows-sources       | 0.38.0      | <https://github.com/python-jsonschema/check-jsonschema>        |
| zizmor                               | v1.30.0     | <https://github.com/zizmorcore/zizmor-pre-commit>              |
| zizmor-sources                       | v1.30.0     | <https://github.com/zizmorcore/zizmor-pre-commit>              |
| actionlint                           | v1.7.12     | <https://github.com/rhysd/actionlint>                          |
| actionlint-sources                   | v1.7.12     | <https://github.com/rhysd/actionlint>                          |
| yamllint                             | v1.38.0     | <https://github.com/adrienverge/yamllint>                      |
| yamllint-sources                     | v1.38.0     | <https://github.com/adrienverge/yamllint>                      |
...
| vale-sync                            | v3.20.0     | <https://github.com/errata-ai/vale>                            |
| vale                                 | v3.20.0     | <https://github.com/errata-ai/vale>                            |
| vale-commit-message                  | v3.20.0     | <https://github.com/errata-ai/vale>                            |
| actions/attest-build-provenance      | v4.2.2      | <https://github.com/actions/attest-build-provenance>           |
| actions/checkout                     | v7.0.1      | <https://github.com/actions/checkout>                          |
| actions/dependency-review-action     | v5.0.0      | <https://github.com/actions/dependency-review-action>          |
| actions/first-interaction            | v3.1.0      | <https://github.com/actions/first-interaction>                 |
| actions/stale                        | v11.0.0     | <https://github.com/actions/stale>                             |
| actions/upload-artifact              | v7.0.1      | <https://github.com/actions/upload-artifact>                   |
...
| release-drafter/release-drafter      | v7.7.0      | <https://github.com/release-drafter/release-drafter>           |
